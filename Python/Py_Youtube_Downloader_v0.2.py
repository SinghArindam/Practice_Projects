...
def download_video():
  ...
  try:
    ...
    # Download functionality with user-defined directory
    download_directory = "path/to/your/downloads"  # Replace with your desired download folder
    stream.download(output_path=download_directory)  # Download to specified directory
    status_label.configure(text=f"Download Complete: {title}", text_color="white", fg_color="green")
